    ...
    return (
        <Card className="p-8 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {[0, 1, 2, 3].map((i) => (
                                <div
                                    ...
                                    style={{
                                        background:
                                            i < passwordStrength
                                                ? // use gradient for progressive strengthening
                                                i === 3
                ...
                <Button
                    type="submit"
                    className="w-full py-2 font-semibold mt-6"
                    style={{
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
                ...
                <button onClick={onSwitchToLogin} className="hover:underline font-semibold" style={{ color: brandPrimary }}>
                    Sign in
                </button>
            </p>
        </Card>
